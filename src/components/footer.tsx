...
const Footer = () => {
    return (
        <div className="p-4 bg-white sm:p-6 dark:bg-gray-900 w-10/12 m-auto mt-4">
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400">
                          <li className="mb-4">
                              <Link href="https://flowbite.com/" className="hover:underline">Frizzy</Link>
                          </li>
                          <li>
                              <Link href="/help" className="hover:underline">Pomoć</Link>
                          </li>
                      </ul>
                  </div>
                  <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="https://flowbite.com/" className="hover:underline">Frizzy</Link>. All Rights Reserved.
              </span>
