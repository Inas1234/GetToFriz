    ...
    return (
      <>
        ...
        <main className="fixed z-50 w-full border border-b-gray-300">
          <nav className=" rounded border-gray-200 bg-white px-2 py-2.5 sm:px-4 w-full">
              ...
              <div className="flex lg:order-1 self-start sm:ml-12 sm:mt-2.5">
                ...
                <div className="relative hidden lg:block">
                  ...
                  <input
                    type="text"
                    id="search-navbar"
                    className="block search rounded-lg border border-gray-300 bg-gray-50 p-2 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Search..."
                  />
                </div>
              {/*phone size*/}
                  ...
                  <li className='order-2 lg:order-1 '>
                    <button onClick={()=>{setNotificationDropdownOpen(!notificationDropdownOpen); setProfileDropdownOpen(false)}} className="flex lg:ml-4 items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-gray-700 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 lg:w-auto">
                      ...
                      <span className="ml-2">Obavijesti</span> <svg className="w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></button>
                        <div id="dropdownNavbar" className={`lg:absolute z-10 ${notificationDropdownOpen ? "block" : "hidden"} notifications mt-2 font-normal notificationssm bg-white divide-y divide-gray-100 rounded-lg shadow lg:w-80`}>
                          {notifications.map((notification) => {
                            return (
                              <ul className="py-2 divide-y divide-gray-50 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                    ...
                    <li className='order-0 lg:order-3'>
                        ...
                        <div id="dropdownNavbar" className={` z-10 ${profileDropdownOpen ? "block" : "hidden"} details mt-2 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow lg:w-36 lg:absolute`}>
                            <ul className="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                              <li>
                                <Link href="/user" className="block px-4 py-2 hover:bg-gray-100 flex items-center space-x-2">
                              ...
                              {props.role !== "salon" && (
                                  <li>
                                    <Link href="/cjenovnik" className="block px-4 py-2 hover:bg-gray-100 flex items-center space-x-2">
                              ...
                              <li>
                                <Link href="/help" className="block px-4 py-2 hover:bg-gray-100 flex items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <div className="py-1">
                              <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
