            ...
            <div className="container mx-auto w-9/12 flex flex-wrap items-center justify-between">
              <Link href="http://localhost:3000" className="flex self-start mt-2.5">
                <img
                  ...
                  className="mr-3 h-6 sm:h-9 self-center"
                  alt="X' Tech Logo"
                />
              ...
              <div className="flex md:order-1 self-start sm:ml-12 sm:mt-2.5">
                {/*phone size*/}
                <button
                  type="button"
              ...
              {/*pc size*/}
              <div
                className={`w-full items-center justify-between md:order-2 md:flex md:w-auto ${open ? "block" : "hidden"}`}
                id="navbar-collapse"
              >
                ...
                {props.loginStatus ? (
                  ...
                  <li>
                      <Link
                        href="#"
                        className="flex items-center justify-between block rounded py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:p-0 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:bg-transparent md:dark:hover:text-white"
                        aria-current="page"
                      >
                    ...
                    <li>
                      <Link
                        href="#"
                        className="flex sm:mr-8 items-center justify-between block rounded py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:p-0 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:bg-transparent md:dark:hover:text-white"
                        aria-current="page"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                    ...
                    <li>
                      <Link
                        href="#"
                        className="block rounded py-2 pl-3 pr-4 text-white dark:text-white md:bg-transparent md:p-0 md:text-blue-700 items-center"
                      >
                        
                        <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" onClick={()=>{setProfileDropdownOpen(!profileDropdownOpen)}} className="flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-gray-400 dark:hover:text-white dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent sm:ml-8"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                        ...
                        <div id="dropdownNavbar" className={`z-10 ${profileDropdownOpen ? "block" : "hidden"} mt-2 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-22 dark:bg-gray-700 dark:divide-gray-600`}>
