...
const Home: NextPage = (props) => {
  ...
  return(
    <>
      ...
      <div className="sm:mt-8 flex sm:flex-row flex-col lg:space-y-0 space-y-8 video-flex items-center justify-evenly ">
    ...
    <div className="bg-blue p-8 m-auto w-10/12 mt-12">
      ...
      <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 w-10/12 m-auto mt-40">
          <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <a href="https://flowbite.com/" className="flex items-center">
                      <img src={logo.src} className="h-16 mr-3 lg:ml-16 lg:mt-8" alt="FlowBite Logo" />
                  </a>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400">
                          <li className="mb-4">
                              <a href="https://flowbite.com/" className="hover:underline">Frizzy</a>
                          </li>
                          <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Frizzy</a>. All Rights Reserved.
              </span>
